...
jQuery(document).ready(
    function () {
        var opts = (function () {
            ...
            instance.serviceName = "HR-CLARIN Repository";
            instance.localauth =
                '<form method="post" action="' + instance.target + 'password-login"> ' +
                    '<p>Sign in using your local account obtained from the HR-CLARIN administrator.</p>' +
        ...
        if (!("aai" in window)) {
            throw "Failed to find AAI@EduHr object. See https://www.srce.unizg.hr/en/aai for more details!";
        }
